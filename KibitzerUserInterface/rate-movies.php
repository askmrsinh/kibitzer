...
<head>
  ...
  <link href="bower_components/bootstrap-rating/bootstrap-rating.css" type="text/css" />
  <!-- Custom CSS -->
...
<body id="movies">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li id="tour1" class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i
              class="glyphicon glyphicon-user"></i><?php echo $_SESSION['fullname'] ?><span
              class="caret"></span></a>
  ...
  <div class="wrapper">
    <ul class="stage clearfix">
      ...
      <li class="scene">
        ...
        <div class="rate">
          <input type="hidden" class="rating-tooltip-manual" data-filled="fa fa-star fa-2x" data-empty="fa fa-star-o fa-2x" />
        </div>
      </li>
  ...
  <script src="bower_components/bootstrap-rating/bootstrap-rating.min.js" type="text/javascript"></script>
